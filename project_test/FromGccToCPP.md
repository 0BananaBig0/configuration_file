  ...
  - [`make` and Makefile](#make-and-makefile)
    ...
    - [Pattern Rules](#pattern-rules)
      ...
      - [6) Example With Variables](#6-example-with-variables)
        ...
        - [Example 11: Limitations And An Error Demonstration](#example-11-limitations-and-an-error-demonstration)
          - [Code](#code-16)
...
2. `include $(DEPS)`: This line includes all the `.d` files in the Makefile. It tells make to use the
   dependency information to track changes to header files. But some issues occur. To deal with these
   issues, use a pseudo target `all` to replace it.
