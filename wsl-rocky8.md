...
sudo dnf install xorg-x11-fonts-misc xorg-x11-fonts-Type*
sudo dnf install rbenv libyaml-devel
sudo dnf remove -y ruby-build
...
sudo dnf install -y python3.12 python3.12-pip perl flex java python3.12-setuptools
...
sudo ln -s /usr/local/bin/gvimdiff /usr/bin/gvimdiff
